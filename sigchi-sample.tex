...
In reference to related works, we manually classified each gesture along seven dimensions: form, nature, flow, dimensionality, handedness, hand shape, and trace. All the gestures were performed by participants from Study 1. Each dimension contains multiple categories, shown in Table \ref{tab:classificationTable}.
...
The trace dimension describes a variety of shapes traced by the moving parts of a gesture. Traces include straight line, fan shape, cone, hand shape expansion and contraction, and traceless. The future drone system should analyze and recognize these traces after capturing the users' motion. The traces are shown in Figure \ref{fig:GestureSetFigure}.
